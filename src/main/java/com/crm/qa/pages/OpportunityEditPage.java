...
public class OpportunityEditPage extends TestBase {
    ...
    @FindBy(xpath = "(//label[text()='Appointment Type Requested']/following::td/span/select)[1]")
    ...
    @FindBy(xpath = "(//label[text()='Channel']/following::td/span/select)[1]")
    WebElement Channel_Lst;

    @FindBy(xpath = "(//label[text()='Lead Source']/following::td/span/select)[1]")
    WebElement LeadSource_Lst;

    @FindBy(xpath = "(//label[text()='Lead Type']/following::td/span/select)[1]")
    WebElement LeadType_Lst;

    @FindBy(xpath = "(//label[text()='Stage']/following::td/span/select)[1]")
    WebElement Stage_Lst;

    @FindBy(xpath = "(//label[text()='Close Date']/following::td/input)[1]")
    ...
    @FindBy(xpath = "(//label[text()='Lead Type Last']/following::td/span/select)[1]")
    WebElement LeadTypeLast_Lst;

    @FindBy(xpath = "(//label[text()='Technology Last']/following::td/input)[1]")
    WebElement TechnologyLast_Textbox;

    @FindBy(xpath = "(//label[text()='Deal Registration Status']/following::td/span/select)[1]")
    ...
    @FindBy(xpath = "(//label[text()='Verification Call Completed']/following::td/input)[1]")
    ...
    @FindBy(xpath = "(//label[text()='HOA Approved']/following::td/input)[1]")
    ...
    @FindBy(xpath = "(//label[text()='Opportunity Name']/following::td/input)[1]")
    ...
    @FindBy(xpath = "(//label[text()='ENational Branch Constant']/following::td/input)[1]")
    ...
    @FindBy(xpath = "(//label[text()='DatewhenSiteAuditwasScheduled']/following::td/input)[1]")
    WebElement DatewhenSiteAuditwasScheduled_Textbox;

    @FindBy(xpath = "(//label[text()='Site Audit Scheduled']/following::td/input)[1]")
    ...
    @FindBy(xpath = "(//label[text()='Project Creation Date']/following::td/input)[1]")
    WebElement ProjectCreationDate_Textbox;

    @FindBy(xpath = "(//label[text()='Plans Reviewed Date']/following::td/input)[1]")
    ...
    @FindBy(xpath = "(//label[text()='Estimated Construction Start Date']/following::td/input)[1]")
    ...
    @FindBy(xpath = "(//label[text()='Forecast Category']/following::td/span/select)[1]")
    ...
    public void FillOpportunityInformation(String SiteDesignReqDate, String SalesRepEmail, String SalesBranch, String SalesTerritory, String LeadOrigin, String RackingType, String Program, String HOAPhone, String DialStatus, String ProductOffering, String Channel, String LeadSource, String LeadType, String Stage, String CloseDate, String Probability, String OpportunityNumber, String ChannelLast, String LeadSourceLast, String LeadTypeLast, String TechnologyLast, String DealRegistrationStatus) throws InterruptedException {
        ...
        RackingTypeLst.selectByVisibleText(Program);
        TestUtil.Sleep(TestUtil.XSMALL_WAIT_TIME);
        ...
        LeadSourceLst.selectByVisibleText(LeadType);
        TestUtil.Sleep(TestUtil.XSMALL_WAIT_TIME);
        ...
        TestUtil.SelectRequiredObjectFromLookup("PV Designer", "Thomas O'Connor");
        TestUtil.SelectRequiredObjectFromLookup("Project Coordinator", "Thomas O'Connor");
    ...
    public void DesignInformation(String Readyfor, String SiteDesignPriority, String SiteDesignStatus) throws InterruptedException{
        ...
        SiteDesignPriorityLst.selectByVisibleText(SiteDesignStatus);
        TestUtil.Sleep(TestUtil.XSMALL_WAIT_TIME);
    ...
    public void MarketAssignmentInfo() throws InterruptedException{
        ...
        TestUtil.SelectRequiredObjectFromLookup("Market Assignment(Sales)", "LGCY Power, LLC");
